Namespace Reports
    Partial Public Class SampleReport
        ...
        Private Sub InitializeComponent()
            ...
            ' xrLabel1
            ' 
            Me.xrLabel1.LocationFloat = New DevExpress.Utils.PointFloat(10.00001F, 54.16667F)
            ...
            ' stringParameter
            ' 
            Me.stringParameter.Description = "String parameter"
            Me.stringParameter.Name = "stringParameter"
            Me.stringParameter.ValueInfo = "String parameter: default value"
            ' 
            ' xrLabel2
            ' 
            Me.xrLabel2.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() { New DevExpress.XtraReports.UI.XRBinding(Me.stringParameter, "Text", "Parameter: {0}")})
